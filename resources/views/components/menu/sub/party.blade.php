...
<li class="flex align-center flex-col cursor-pointer">
        ...
        class="relative flex flex-row justify-between items-center h-11 focus:outline-none hover:bg-gray-300
                        ...
                        <span class="inline-flex justify-center items-center space-x-3">
                            <x-icons.icon-fill iconfill="tag-menu"
                                               class="w-4 h-auto block fill-gray-300 group-hover:fill-gray-700"/>
    ...
    <div x-show="selected === 6" class="p-1 flex flex-col">
        ...
        <ul class="grid-cols-1 grid bg-gray-300">
            @include('components.menu.items.party-menu')
            <li class="bg-gray-300 mt-0.5"></li>
        </ul>
    </div>
</li>
